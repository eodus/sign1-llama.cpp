...
enum llm_tensor {
    ...
    LLM_TENSOR_FFN_DOWN_EXPS_SIGN_U,
    LLM_TENSOR_FFN_DOWN_EXPS_SIGN_V,
    LLM_TENSOR_FFN_DOWN_EXPS_DBF_DIN,
    LLM_TENSOR_FFN_DOWN_EXPS_DBF_DMID,
    LLM_TENSOR_FFN_DOWN_EXPS_DBF_DOUT,
    LLM_TENSOR_FFN_GATE_EXPS_SIGN_U,
    LLM_TENSOR_FFN_GATE_EXPS_SIGN_V,
    LLM_TENSOR_FFN_GATE_EXPS_DBF_DIN,
    LLM_TENSOR_FFN_GATE_EXPS_DBF_DMID,
    LLM_TENSOR_FFN_GATE_EXPS_DBF_DOUT,
    LLM_TENSOR_FFN_UP_EXPS_SIGN_U,
    LLM_TENSOR_FFN_UP_EXPS_SIGN_V,
    LLM_TENSOR_FFN_UP_EXPS_DBF_DIN,
    LLM_TENSOR_FFN_UP_EXPS_DBF_DMID,
    LLM_TENSOR_FFN_UP_EXPS_DBF_DOUT,
