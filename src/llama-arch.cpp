...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FFN_DOWN_EXPS_SIGN_U,                   "blk.%d.ffn_down_exps_u" },
    { LLM_TENSOR_FFN_DOWN_EXPS_SIGN_V,                   "blk.%d.ffn_down_exps_v" },
    { LLM_TENSOR_FFN_DOWN_EXPS_DBF_DIN,                  "blk.%d.ffn_down_exps_din" },
    { LLM_TENSOR_FFN_DOWN_EXPS_DBF_DMID,                 "blk.%d.ffn_down_exps_dmid" },
    { LLM_TENSOR_FFN_DOWN_EXPS_DBF_DOUT,                 "blk.%d.ffn_down_exps_dout" },
    { LLM_TENSOR_FFN_GATE_EXPS_SIGN_U,                   "blk.%d.ffn_gate_exps_u" },
    { LLM_TENSOR_FFN_GATE_EXPS_SIGN_V,                   "blk.%d.ffn_gate_exps_v" },
    { LLM_TENSOR_FFN_GATE_EXPS_DBF_DIN,                  "blk.%d.ffn_gate_exps_din" },
    { LLM_TENSOR_FFN_GATE_EXPS_DBF_DMID,                 "blk.%d.ffn_gate_exps_dmid" },
    { LLM_TENSOR_FFN_GATE_EXPS_DBF_DOUT,                 "blk.%d.ffn_gate_exps_dout" },
    { LLM_TENSOR_FFN_UP_EXPS_SIGN_U,                     "blk.%d.ffn_up_exps_u" },
    { LLM_TENSOR_FFN_UP_EXPS_SIGN_V,                     "blk.%d.ffn_up_exps_v" },
    { LLM_TENSOR_FFN_UP_EXPS_DBF_DIN,                    "blk.%d.ffn_up_exps_din" },
    { LLM_TENSOR_FFN_UP_EXPS_DBF_DMID,                   "blk.%d.ffn_up_exps_dmid" },
    { LLM_TENSOR_FFN_UP_EXPS_DBF_DOUT,                   "blk.%d.ffn_up_exps_dout" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_FFN_DOWN_EXPS_SIGN_U,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_DOWN_EXPS_SIGN_V,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_DOWN_EXPS_DBF_DIN,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_DOWN_EXPS_DBF_DMID,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_DOWN_EXPS_DBF_DOUT,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_GATE_EXPS_SIGN_U,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_GATE_EXPS_SIGN_V,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_GATE_EXPS_DBF_DIN,      {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_GATE_EXPS_DBF_DMID,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_GATE_EXPS_DBF_DOUT,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_UP_EXPS_SIGN_U,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_UP_EXPS_SIGN_V,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_UP_EXPS_DBF_DIN,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_UP_EXPS_DBF_DMID,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_UP_EXPS_DBF_DOUT,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
